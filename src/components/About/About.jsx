    ...
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-2">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          <h3 className="text-l sm:text-xl md:text-2xl font-semibold mb-4 text-[#8245ec] leading-tight">
          ...
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/14yxOEcxkfsRBlr6vduxm0zEEe1J2F8u8/view?usp=drive_link"
            target="_blank"
